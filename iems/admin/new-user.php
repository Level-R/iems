...
<main id="main">
    ...
    <div class="container-fluid">
      <div class="row g-3 justify-content-between align-items-center py-3">
        ...
        <div class="col-12 col-md-6 text-start">
          <h2 class="roboto-body text-capitalize">Add <?php echo htmlspecialchars($_REQUEST['user'] ?? '', ENT_QUOTES); ?></h2>
        </div>
  ...
  <!-- user count section -->
  <section class="important_link d-none d-md-block py-3 py-md-5">
    <div class="container-fluid">
            ...
            <div class="col-12 py-2 px-1">
              <div class="row align-content-center align-items-center">
                ...
                <div class="col-12 col-sm-6 text-sm-start text-center mb-2 mb-sm-0">
                  <h5 class="card-title text-capitalize">Add New <?php echo $_REQUEST['user'] ?? ''; ?></h5>
                </div>
          ...
          <div class="row ${1| ,row-cols-2,row-cols-3, auto,justify-content-md-center,|}">
            ...
            <?php if ($userRole === 'teacher'): ?>
              ...
              <?php if (isset($_SESSION['error'])): ?>
                <div id="flashMessage" class="alert alert-danger text-center">
              ...
              <?php endif; ?>
              <!-- Success/error Message -->
              <form class="row g-3 needs-validation" action="/iems/admin/data/manage-user-data.php?user=<?php echo $_REQUEST['user']; ?>" method="POST" novalidate>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" id="Qualification" name="qualification" placeholder="bachelor of arts, BA, Science,..." required>
                  <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" id="Department" name="department" placeholder="CSE, EEE, English, Math,..." required>
                  <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" id="subjects" name="subject" placeholder="Speciality: math, data science, bangla,..." required>
                  <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" name="position" placeholder="Principals, senior, junior, Assistant..." id="validationCustom03" required>
                  <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" name="blood_group" placeholder="Blood: A+, A-, B+, B-, AB-,...." id="blood_group" required>
                  <div class="invalid-feedback">
                    Please provide a valid position.
                  </div>
                </div>
                <div class="col-md-4">
                  ...
                  <input type="number" class="form-control" name="experience_years" placeholder="2,5,7,..." id="experience_years" required>
                  <div class="invalid-feedback">
                    Please provide a valid position.
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  ...
                  <input type="password" class="form-control" name="password" placeholder="enter a stronge password" required>
                  <div class="invalid-feedback">
            ...
            <?php elseif ($userRole == 'moderator'): ?>
              <div class="alert alert-success">valid <?= htmlspecialchars($userRole)?> user type selected.</div>
            <?php else: ?>
